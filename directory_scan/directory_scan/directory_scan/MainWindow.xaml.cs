...
namespace directory_scan
{
    ...
    public partial class MainWindow : Window
    {
        ...
        public void CreateTime()//Создаем таймер
        {
        ...
        public void dispatcherTimer_Tick(object sender, EventArgs e)//даем команду что делать по таймеру (сканировать)
        {
            Scaning();
        }
        ...
        private void Scaning()//Сканирование каталога, берем все файлы которые там есть и сравниваем с названием файла который у нас в текстбоксе 
        {
            ...
            if(hdDirectoryInWhichToSearch.Exists)
            {
